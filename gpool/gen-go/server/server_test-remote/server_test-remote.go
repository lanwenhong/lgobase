...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  i32 add1(i16 magic, i16 ver,  ext, i32 a, i32 b)")
	fmt.Fprintln(os.Stderr, "  i32 postUser(GetUserRequest req)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := server.NewServerTestClient(thrift.NewTStandardClient(iprot, oprot))
	...
	case "add1":
		if flag.NArg() - 1 != 5 {
			fmt.Fprintln(os.Stderr, "Add1 requires 5 args")
			flag.Usage()
		}
		...
		containerStruct2 := server.NewServerTestAdd1Args()
		err28 := containerStruct2.ReadField3(context.Background(), jsProt27)
		if err28 != nil {
			Usage()
			return
		}
		argvalue2 := containerStruct2.Ext
		value2 := argvalue2
		...
		value4 := argvalue4
		fmt.Print(client.Add1(context.Background(), value0, value1, value2, value3, value4))
		fmt.Print("\n")
		break
	case "postUser":
		if flag.NArg() - 1 != 1 {
		...
		argvalue0 := server.NewGetUserRequest()
